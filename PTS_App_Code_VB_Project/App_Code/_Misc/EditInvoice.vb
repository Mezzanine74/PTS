...
Public Class EditInvoice
    ...
    Public Sub UpdateInvoice(ByVal PayReqNo As Integer, _
    ...
    Public Sub DeleteInvoice(ByVal PayReqNo As Integer)
    ...
    Public Function BindInvoice(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal ProjectID As Integer, ByVal SupplierID As String) As DataTable
        'Dim con As New SqlConnection(ConfigurationManager.ConnectionStrings("MERCURYConnectionString").ConnectionString)
        Dim con As SqlConnection = ConnectionStringsPTS.GetConnectionStringMain

        con.Open()
        Dim com As New SqlCommand("GET_Table3_Invoice", con)
        com.CommandType = CommandType.StoredProcedure
    ...
    Public Function GetInvoiceCount(ByVal ProjectID As Integer, ByVal SupplierID As String) As Integer
        Dim con As New SqlConnection(ConfigurationManager.ConnectionStrings("MERCURYConnectionString").ConnectionString)
        con.Open()
        Dim com As New SqlCommand("GetInvoiceCount", con)
        com.CommandType = CommandType.StoredProcedure
        com.Parameters.Add("@ProjectID", SqlDbType.Int, 4).Value = ProjectID
        com.Parameters.Add("@SupplierID", SqlDbType.NChar, 12).Value = SupplierID
        ...
        While dr.Read()
            If dr("InvoiceCount") IsNot Nothing Then
                Integer.TryParse(dr("InvoiceCount").ToString(), count)
            End If
        End While
        Return count
    End Function
