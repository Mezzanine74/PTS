<%@ Page Title="" Language="VB" MasterPageFile="~/site.master" AutoEventWireup="false" CodeFile="ProgressMeasurementMonitor.aspx.vb" Inherits="ProgressMeasurementMonitor" %>
...
<asp:Label ID="LabelCount" runat="server" Text="0" CssClass="hidepanel"></asp:Label>

<div style="text-align: center; width: 100%">
    <asp:Button ID="ButtonSeeAgainstCost" runat="server" Text="See Against Cost" />
