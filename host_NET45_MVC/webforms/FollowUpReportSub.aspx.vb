...
Partial Class _Nakl_FollowUpReportDeliveryFinanceFasterSubRC
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If Not IsPostBack Then
      Try
                RenderReport.Render("HTML", ReportViewer_, "_Nakl_FollowUpReportSubExcVATRev", _
                            "Currency", _
  ...
  End Sub
    ...
    Private Sub ExportToExcel()
        ...
        RenderReport.Render("Excel", ReportViewer_, "_Nakl_FollowUpReportSubExcVATRev", _
                            "Currency", _
                            Request.QueryString("Currency").ToString, _
                            "ProjectID", _
                            Request.QueryString("ProjectID").ToString, _
