...
Partial Class login2011Browser
  Inherits System.Web.UI.Page

    Protected Sub ButtonLogin_Click(sender As Object, e As EventArgs)

        If Membership.ValidateUser(TextBoxUser.Text.Trim, TextBoxPassword.Text.Trim) Then
            FormsAuthentication.RedirectFromLoginPage(TextBoxUser.Text.Trim, False)
        Else
