<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="SearchContractsFeedSupplierDetails.aspx.vb" Inherits="SearchContractsFeedSupplierDetails" %>
    ...
    <table>
        <tr>
            <td>
                ...
                <asp:Button ID="BtnGetData" runat="server" Text="Save Data" Font-Size="Large" Height="50px" Width="250px" />
            </td>
        </tr>
    </table>
