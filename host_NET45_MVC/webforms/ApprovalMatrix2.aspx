...
AutoEventWireup="false" CodeFile="ApprovalMatrix2.aspx.vb" Inherits="ApprovalMatrixRev33422" MaintainScrollPositionOnPostback="True"   %>
  ...
  <%-- /MODAL POPUP REMARK --%>
    ...
    <%--                        <asp:Literal ID="LiteralBudget" runat="server" Text='<%# Bind("Budget", "{0:N2}")%>'></asp:Literal>--%>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate>
                        <table id="tblR1" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <asp:Literal ID="LiteralUserRank1" runat="server" Text='<%# Bind("UserRank1") %>'></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank1" runat="server" CommandName="ApprovalUserRank1"
                                        CommandArgument='<%# Container.DataItemIndex %>' CausesValidation="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank1" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank1" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank1">Add Comment</asp:LinkButton>

                                    <%--                                            <asp:Label ID="LabelNotificationNumberUserRank1" runat="server" Text="2" CssClass="LabelNotification"></asp:Label>--%>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate>
                        <table id="tblR2" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <asp:Literal ID="LiteralUserRank2" runat="server" Text='<%# Bind("UserRank2") %>'></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank2" runat="server" CommandName="ApprovalUserRank2"
                                        CommandArgument='<%# Container.DataItemIndex %>' CausesValidation="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank2" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank2" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank2">Add Comment</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate>
                        <table id="tblR3" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <span class="hidepanel">
                                        <asp:Literal ID="LiteralUserRank3" runat="server" Text='<%# Bind("UserRank3") %>'></asp:Literal></span>
                                    <asp:Literal ID="LiteralShowLawyersToClient" runat="server" Text="lawyers"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank3" runat="server" CommandName="ApprovalUserRank3"
                                        CommandArgument='<%#Container.DataItemIndex%>' CausesValidation="False" />
                            ...
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank3" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank3" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank3">Add Comment</asp:LinkButton>

                                    <%--                                            <asp:Label ID="LabelNotificationNumberUserRank3" runat="server" Text="2" CssClass="LabelNotification"></asp:Label>--%>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate>
                        <table id="tblR4" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <asp:Literal ID="LiteralUserRank4" runat="server" Text='<%# Bind("UserRank4") %>'></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank4" runat="server" CommandName="ApprovalUserRank4"
                                        CommandArgument='<%# Container.DataItemIndex %>' CausesValidation="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank4" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank4" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank4">Add Comment</asp:LinkButton>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate>
                        <table id="tblR6" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <asp:Literal ID="LiteralUserRank6" runat="server" Text='<%# Bind("UserRank6") %>'></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank6" runat="server" CommandName="ApprovalUserRank6"
                                        CommandArgument='<%# Container.DataItemIndex %>' CausesValidation="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank6" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank6" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank6">Add Comment</asp:LinkButton>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center" >
                    ...
                    <ItemTemplate>
                        <table id="tblR7" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <asp:Literal ID="LiteralUserRank7" runat="server" Text='<%# Bind("UserRank7") %>'></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank7" runat="server" CommandName="ApprovalUserRank7"
                                        CommandArgument='<%# Container.DataItemIndex %>' CausesValidation="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank7" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank7" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank7">Add Comment</asp:LinkButton>
                ...
                <asp:TemplateField HeaderStyle-Width="79px" ItemStyle-HorizontalAlign="Center"  > 
                    ...
                    <ItemTemplate>
                        <table id="tblR8" runat="server" Class="table table-nonfluid min100">
                            <tr>
                                <td class="style1">
                                    <asp:Literal ID="LiteralUserRank8" runat="server" Text='<%# Bind("UserRank8") %>'></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                    <asp:ImageButton ID="ImageButtonApprovalUserRank8" runat="server" CommandName="ApprovalUserRank8"
                                        CommandArgument='<%# Container.DataItemIndex %>' CausesValidation="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:Literal ID="LiteralWhenApprovedUserRank8" runat="server" Text="When Approved"></asp:Literal>
                                </td>
                            </tr>
                            <tr>
                                <td class="style3">
                                    <asp:LinkButton ID="LinkButtonRemarkUserRank8" runat="server"
                                        CommandArgument='<%# Container.DataItemIndex %>'
                                        CommandName="RemarkUserRank8">Add Comment</asp:LinkButton>
