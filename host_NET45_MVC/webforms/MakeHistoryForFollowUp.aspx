<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MakeHistoryForFollowUp.aspx.vb" Inherits="MakeHistoryForFollowUp" %>
...
<body >
    ...
    <div>
      ...
      Finish><asp:TextBox ID="TextBoxFinish" runat="server" Text=" 00:00:00"></asp:TextBox>
                    ...
                    CssClass="DrpDwnListGeneral" DataValueField="ProjectID" DataTextField="DayOfRun"
                    DataSourceID="SqlDataSource1" >
                </asp:DropDownList>
                
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
      ConnectionString="<%$ ConnectionStrings:MERCURYConnectionString %>" SelectCommand="SELECT [ProjectID], Max(DayOfRun) As DayOfRun
  FROM [Table_HistoryFollowUpTotal]
