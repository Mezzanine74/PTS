...
Partial Class _Nakl_FollowUpReportBySupplierExcVAT
  Inherits System.Web.UI.Page

  Protected Sub ButtonRunReport_Click(sender As Object, e As System.EventArgs) Handles ButtonRunReport.Click
        RenderReport.Render("html", ReportViewerFollowUpReportBySupplierExcVAT, "_Nakl_FollowUpReportBySupplierExcVAT", "ProjectID", DropDownListPrj.SelectedValue, "Currency", DropDownListCurrency.SelectedValue)
  End Sub
  ...
  Protected Sub ImageButtonExportExcelProcurementReportTotal_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonExportExcelProcurementReportTotal.Click
        RenderReport.Render("excel", ReportViewerFollowUpReportBySupplierExcVAT, "_Nakl_FollowUpReportBySupplierExcVAT", "ProjectID", DropDownListPrj.SelectedValue, "Currency", DropDownListCurrency.SelectedValue)
  End Sub
