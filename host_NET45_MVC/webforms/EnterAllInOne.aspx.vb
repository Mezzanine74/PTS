...
Partial Class EnterAllInOne
    ...
    Protected Sub ButtonEnter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonEnter.Click
        ...
        For Each row As GridViewRow In GridViewFinance.Rows
            If row.RowType = DataControlRowType.DataRow Then
                ...
                SqlDataSourceInsertPO.InsertParameters("SupplierID").DefaultValue = "7717148677"
                ...
                SqlDataSourceInsertPO.InsertParameters("PO_Currency").DefaultValue = "Rub"
                ...
                Dim _paymentdate As String = Convert.ToDateTime(row.Cells(3).Text + " 00:00:00")
                Dim _rubledollar As Decimal = PTS_MERCURY.helper.Table8_ExchangeRates.GetRowByPrimaryKey(_paymentdate).RubbleDollar
                Dim _rubleeuro As Decimal = PTS_MERCURY.helper.Table8_ExchangeRates.GetRowByPrimaryKey(_paymentdate).RubbleEuro
                ...
                SqlDataSourcePayLog.InsertParameters("PaymentDate").DefaultValue = _paymentdate
                ...
                SqlDataSourcePayLog.InsertParameters("RubbleDollar").DefaultValue = _rubledollar
                SqlDataSourcePayLog.InsertParameters("RubbleDollar").Type = TypeCode.Decimal
                SqlDataSourcePayLog.InsertParameters("RubbleEuro").DefaultValue = _rubleeuro
    ...
    Protected Sub ImageButtonExportExcel_Click(sender As Object, e As ImageClickEventArgs)
        ...
        RenderReport.Render("Excel", ReportViewerCostReport, "RecentEntriesFrom1S ")
