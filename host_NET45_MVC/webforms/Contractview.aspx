...
AutoEventWireup="false" EnableEventValidation ="false" CodeFile="Contractview.aspx.vb" Inherits="contractView_ApprovalMatrixPTM3SS" %>
...
.module {
    display: block;
  -webkit-animation: flyin 1200ms ease-in;
  -moz-animation: flyin 1200ms ease-in;
  -o-animation: flyin 1200ms ease-in;
  -ms-animation: flyin 1200ms ease-in;
        animation: flyin 1200ms ease-in;
            ...
            <div class="modal-content modal_inlineBlock">
                ...
                <div class="modal-body" style="width:800px;" >
                    <asp:Panel ID="panelContainer" runat="server">
                        <dx:ASPxFileManager ID="ASPxFileManager1" runat="server" Visible="true" Height="300" ClientInstanceName="ASPxFileManager1Client" >
    ...
    <div id="divContractSearch" class="modal">
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content modal_inlineBlock">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><%= BodyTexts.Ref("VdjBmcRPS0G1oeSSMZnqMw")%></h4>
                </div>
                <div class="modal-body" >
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <td><%= BodyTexts.Ref("Mu+drePgpEK6h8XzFfTOJg")%>
                                </td>
                                <td><%= BodyTexts.Ref("WCc0K46nMU6P4KVjfJyRyQ")%>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <td><%= BodyTexts.Ref("KmvRdiNMB0CjdFDWlFkG2g")%>
                                </td>
                                <td><%= BodyTexts.Ref("/BFB8a1YN0S3U9og0yYsEA")%>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <table class="table">
                        ...
                        <thead>
                            <tr>
                                <td style="max-width:85px"><%= BodyTexts.Ref("b/QwmB2AWEmXNrVeVHPG7g")%>
                                </td>
                                <td style="max-width:85px"><%= BodyTexts.Ref("aUlY16DSxEuv5OYTuG/x+g")%>
                                </td>
                                <td style="max-width:182px"><%= BodyTexts.Ref("foHRgj5mokmXEh62sTOoiQ")%>
                                </td>
                                <td><%= BodyTexts.Ref("ofeMLaQHw0mejHavxFcTrg")%>
                                </td>
                                <td><%= BodyTexts.Ref("b2HPiY0Ml0esWk6dZkswtg")%>
                                </td>
                                <td><%= BodyTexts.Ref("mB+gkXNFaEegQ/Gm8GRgsA")%>
                                </td>
                                <td><%= BodyTexts.Ref("wt6Qt9QUh0GDaiAKFZhS0A")%>
                                </td>
                                <td><%= BodyTexts.Ref("v4yTZj0Pi0CtAif6PQDZ7w")%>
                                </td>
                                <td><%= BodyTexts.Ref("0AlnhV1jr0GcYHql+D2yVw")%>
                                </td>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr style="font-size:11px;">
                                <td style="max-width:85px;">
                                    <asp:TextBox ID="textBoxSearchInputContractNo" runat="server" placeholder="contract no" Width="80px"  ></asp:TextBox>
                                </td>
                                <td style="max-width:85px">
                                    <asp:TextBox ID="textBoxSearchInputContractDate" runat="server" placeholder="contract date" CssClass="add_datepicker" Width="80px" ></asp:TextBox>
                                </td>
                                <td style="max-width:182px">
                                ...
                                <td>
                                    ...
                                    <div style="margin-bottom:3px;">
                                        <span style="width:80px !important; display:inline-block;"><%= BodyTexts.Ref("wbDq2ox4kkis4fjfBgtS2A")%></span>
                                    ...
                                    <div>
                                        <span style="width:80px !important; display:inline-block;"><%= BodyTexts.Ref("z7BNFVb4+kGOvXnGDavqKQ")%></span>
                                ...
                                <td>
                                    ...
                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("KD68h+EG5UylRNAm4jfHOA")%></span>
                                        <asp:CheckBox ID="cbxSearchInputCurrencyRuble" runat="server" Checked="true" />
                                    </div>

                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("sbIRip+UNUucKSuF/1bY7w")%></span>
                                        <asp:CheckBox ID="cbxSearchInputCurrencyDollar" runat="server" Checked="true" />
                                    </div>

                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("vNjytH8znE+Pu6i5ypGzPw")%></span>
                                ...
                                <td>
                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("wt6Qt9QUh0GDaiAKFZhS0A")%></span>
                                ...
                                <td>
                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("v4yTZj0Pi0CtAif6PQDZ7w")%></span>
                                ...
                                <td>
                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("zqsUS0etCEWrGK8Jk4AYew")%></span>
                                    ...
                                    <div style="margin-bottom:3px;">
                                        <span style="width:50px !important; display:inline-block;"><%= BodyTexts.Ref("dE17d7neyEa2VeJnyQhM3g")%></span>
                    ...
                    <div style="float:left;">
                        <input id="btnReset" Class="btn btn-lg-search btn-danger" type="button" value="<%= BodyTexts.Ref("Wefr6iBt0ky6UWvAvQBtjg")%>"  />
                    </div>
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding:2px;">
                            <a ID="btnSearchContract" runat="server" style="cursor:pointer; font-size:xx-large;" class="btn btn-lg btn-success"><%= BodyTexts.Ref("x/slU4rYmkSvuBtKR49oQg")%></a>
                        ...
                        <table>		
                            ...
                            <asp:Panel ID="PanelCommonInformationR1Item" runat="server" CssClass="panel panel-info " Width="1200px">
                                ...
                                <span style="float:right;">  
                                    <asp:HyperLink ID="HyperlinkContractCoverPage" runat="server" Target="_blank" >PRINT</asp:HyperLink>
                                </span>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:ImageButton ID="ImageButtonClientContractAktToWorkContractItem" runat="server" ImageUrl="~/Images/folder.png" Visible="false"
                                                 CommandName="AktOfWorkContractItem" />
                                                <asp:Label ID="LabelLinkAktOfWorkContractItem" runat="server" Visible="false" ></asp:Label>
                        ...
                        <table >		
                            ...
                            <asp:Panel ID="PanelCommonInformationAddItem" runat="server" CssClass="panel panel-info " Width="1200px">
                                <div class="panel-heading">
                                    <%= BodyTexts.Ref("Cz1u1YxQmUO8D6vQzUaGEA")%>
                                <span style="float:right;">  
                                    <asp:HyperLink ID="HyperlinkAddendumCoverPage" runat="server" Target="_blank" >PRINT</asp:HyperLink>
                                </span>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:ImageButton ID="ImageButtonClientContractAktToWorkAddendumItem" runat="server" ImageUrl="~/Images/folder.png" Visible="false"
                                                 CommandName="AktOfWorkAddendumItem" />

                                                <asp:Label ID="LabelLinkAktOfWorkAddendumItem" runat="server" Visible="false" ></asp:Label>
...
<asp:Label ID="LabelWarningPoDublication" runat="server"></asp:Label>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td class="td_fl_mng">
                                                            <asp:ImageButton ID="ImageButtonLinkToTemplatefile_DOC" runat="server" 
                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "AddendumLinkToTemplatefile_DOC") %>' 
                                                                CommandName="OpenDOCeditAdd" />

                                                        </td>
                                                        <td class="td_fl_mng">
                                                            <asp:ImageButton ID="ImageButtonLinkToPDFcopy" runat="server" 
                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "AddendumLinkToPDFcopy") %>' 
                                                                CommandName="OpenPDFeditAdd" />
                                                        </td>
                                                    </tr>
                                                </table>
      ...
      <table style="background-color: #CCCCCC">
       <tr>
           <th colspan="12" style="text-align:center; color:Red; display:none;">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:ImageButton ID="ImageButtonFileUploadAktOfWorkAddendum" runat="server" ImageUrl="~/Images/folder.png"
                                                 CommandName="AktOfWorkAddendum" />

                                                <asp:Label ID="LabelLinkAktOfWorkAddendum" runat="server" Visible="false" ></asp:Label>
...
<asp:Label ID="LabelWarningPoDublication" runat="server"></asp:Label>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:ImageButton ID="ImageButtonFileUploadAktOfWorkContract" runat="server" ImageUrl="~/Images/folder.png"
                                                 CommandName="AktOfWorkContract" />

                                                <asp:Label ID="LabelLinkAktOfWorkContract" runat="server" Visible="false" ></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSourceForContractGrid" runat="server" 
        ...
        DeleteCommand="
                         ...
                         <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownListPrjID" Name="ProjectID" PropertyName="Text" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="DropDownListSupplier" Name="SupplierID" PropertyName="Text" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="TextBoxEntryInterval" Name="entrytimeinterval" PropertyName="Text" DefaultValue="-" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="TextBoxApprovalInterval" Name="approvaltimeinterval" PropertyName="Text" DefaultValue="-" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="TextBoxUserName" Name="UserName" PropertyName="Text" DefaultValue="-" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="hiddenSearchAdvanceMode" Name="SearchAdvanceMode" PropertyName="Value" DefaultValue="0" Type="Int16" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="hiddenSearchInputProjects" Type="String" Name="SearchInputProjects" PropertyName="Value" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="hiddenSearchInputSuppliers" Type="String" Name="SearchInputSuppliers" PropertyName="Value" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="textBoxSearchInputContractNo" Type="String" Name="SearchInputContractNo" PropertyName="Text" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="textBoxSearchInputContractDate" Type="String" Name="SearchInputContractDate" PropertyName="Text" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="textBoxSearchInputContractDescription" Type="String" Name="SearchInputContractDescription" PropertyName="Text" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="ddlBoxSearchInputSignBysupplier" Type="String" Name="SearchInputSignBysupplier" PropertyName="Text" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="ddlSearchInputSignByMercury" Type="String" Name="SearchInputSignByMercury" PropertyName="Text" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="ddlBoxSearchInputAdvance" Type="String" Name="SearchInputAdvance" PropertyName="SelectedValue" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="ddlSearchInputRetention" Type="String" Name="SearchInputRetention" PropertyName="SelectedValue" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="ddlBoxSearchInputDraft" Type="String" Name="SearchInputDraft" PropertyName="SelectedValue" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="ddlSearchInputFinal" Type="String" Name="SearchInputFinal" PropertyName="SelectedValue" DefaultValue="" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="cbxSearchInputContractTypeSer" Type="Boolean" Name="SearchInputContractTypeSer" PropertyName="Checked" DefaultValue="1" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="cbxSearchInputContractTypeSub" Type="Boolean" Name="SearchInputContractTypeSub" PropertyName="Checked" DefaultValue="1" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="cbxSearchInputContractTypeSup" Type="Boolean" Name="SearchInputContractTypeSup" PropertyName="Checked" DefaultValue="1" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="cbxSearchInputCurrencyRuble" Type="Boolean" Name="SearchInputCurrencyRuble" PropertyName="Checked" DefaultValue="1" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="cbxSearchInputCurrencyDollar" Type="Boolean" Name="SearchInputCurrencyDollar" PropertyName="Checked" DefaultValue="1" ConvertEmptyStringToNull="false"/>
                            <asp:ControlParameter ControlID="cbxSearchInputCurrencyEuro" Type="Boolean" Name="SearchInputCurrencyEuro" PropertyName="Checked" DefaultValue="1" ConvertEmptyStringToNull="false"/>
                        </SelectParameters>   
    </asp:SqlDataSource>
