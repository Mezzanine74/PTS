<%@ Page Title="" Language="VB" MasterPageFile="~/site.master"  MaintainScrollPositionOnPostback="true" Trace="true"
AutoEventWireup="false" EnableEventValidation ="false" CodeFile="Contractview.aspx.vb" Inherits="contractView_ApprovalMatrixPTM3SSb" %>
    ...
    <table>
        <tr>
            <td style="width: 350px; background-color: #F8F9F9; padding: 2px;">
                ...
                <asp:SqlDataSource ID="SqlDataSourcePrj" runat="server"
                    ...
                    SelectCommand="
                        ...
                        FROM         (         SELECT     -1 AS ProjectID, N'__Select Project' AS ProjectName, NULL AS UserName
                                               UNION ALL
                                               SELECT     0 AS ProjectID, N'_ALL PROJECTS' AS ProjectName, NULL AS UserName
                                               UNION ALL
            ...
            <td style="width: 164px; background-color: #F8F9F9; padding: 2px;">
                <asp:TextBox ID="TextBoxEntryInterval" runat="server" CssClass="add_daterangepicker" AutoPostBack="true" Style="margin-bottom: 2px;"
                    placeholder="Entry Interval" Width="160px" OnTextChanged="TextBoxEntryInterval_TextChanged"></asp:TextBox>

                <asp:TextBox ID="TextBoxApprovalInterval" runat="server" CssClass="add_daterangepicker" AutoPostBack="true"
                    placeholder="Approval Interval" Width="160px"></asp:TextBox>
            ...
            <td style="width: 304px; background-color: #F8F9F9; padding: 2px;">
                <asp:TextBox ID="TextBoxSearch" runat="server" OnTextChanged="TextBoxSearch_TextChanged"
                    Width="300px" Style="font-family: Consolas" placeholder="type to search for Contract No ..."
                        ...
                        <table>		
                            ...
                            <asp:Panel ID="PanelCommonInformationR1Item" runat="server" CssClass="panel panel-info " Width="1200px">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table" id="tblCommonNewGN" runat="server">
                                          <tr>
                                           <td style="width:100px;">
                                             <asp:Button ID="ButtonExceptionalApprove" runat="server" CausesValidation="False" CommandName="ExceptionalApproveContract"  
...
<%--                                            <asp:Panel ID="PanelNominated" runat="server" >
                                           ...
                                           <td style="padding-left:10px;">
                                                   ...
                                                   <asp:panel id="panelNewSupplier" runat="server"  Visible="false" CssClass="alert alert-danger"
                                                       width="150">
                                                       This is new supplier!
                                                       <br />
      ...
      <!---- COMMERCIAL TERMS ---------------------------------------------------------->
                            ...
                            <asp:Panel ID="PanelCommercialTermsContractItem" runat="server" CssClass="panel panel-info float_left" Width="1000px">
                                <div class="panel-heading">
                                    Commercial Items
      ...
      <!---------------------------------------------------------- COMMERCIAL TERMS ---->
                    ...
                    <asp:Panel ID="PanelTagContract" CssClass="panel panel-info float_left " Width="200px" runat="server">
                        <div class="panel-heading">
                            Tags
                        </div>
                        <div class="panel-body">
                        ...
                        <%--hiddenfield should be next for scripts--%>
                ...
                <ItemTemplate>
                        ...
                        <table >		
                            ...
                            <asp:Panel ID="PanelCommonInformationAddItem" runat="server" CssClass="panel panel-info " Width="1200px">
                                ...
                                <table id="tblAddCommonNewGN" runat="server" class="table">
                                 <tr>
                                <td>
                                  <usercontrol:ImageUserPhoto ID="ImageRequestedBy" runat="server" UserName='<%# Eval("RequestedBy")%>' />
                                </td>
                            ...
                            <asp:Panel ID="PanelCommercialTermsAddendumItem" runat="server" CssClass="panel panel-info float_left " Width="1000px">
                                <div class="panel-heading">
                                    Commercial Items
                                    <span style="float:right;"><asp:literal ID="LiteralCostCode" Text='<%# Bind("CostCode")%>' runat="server" ></asp:literal></span>
                                </div>
                    ...
                    <asp:Panel ID="PanelTagAddendum" CssClass="panel panel-info float_left " Width="200px" runat="server">
                        <div class="panel-heading">
                            Tags
                        </div>
                        <div class="panel-body">
...
<asp:Label ID="LabelWarningPoDublication" runat="server"></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSourceShowAddendum" runat="server" 
        ConnectionString="<%$ ConnectionStrings:MERCURYConnectionString %>" 
        SelectCommand=" SELECT     Table_Addendums.AddendumID, Table_Addendums.ContractID, RTRIM(Table_Addendums.PO_No) AS PO_No, RTRIM(Table_Addendums.AddendumNo) 
                      ...
                      RTRIM(Table_Addendums.AddendumLinkToTemplatefile_DOC) AS AddendumLinkToTemplatefile_DOC, Table_Addendums.AddendumSignBySupplier, 
                      Table_Addendums.AddendumSignByMercury, Table_Addendums.AddendumCollectionBySupplier, RTRIM(Table_Addendums.AddendumGivenTo) 
                      AS AddendumGivenTo, RTRIM(Table_Addendums.AddendumLinkToPDFcopy) AS AddendumLinkToPDFcopy, Table_Addendums.AddendumArchivedByMercury, 
                      ...
                      Table_Addendums.NewGeneration, Table_Addendums.RequestedBy, Table_Addendums.Penalties, Table_Addendums.PenaltiesNote, Table_Addendums.Budget, Table_Addendums.BudgetLinkToPDF ,
                      Table_Addendums.Advance, Table_Addendums.StartDate, Table_Addendums.FinishDate, Table_Addendums.DeliveryTerms, Table_Addendums.GuaranteePeriod, 
                      Table_Addendums.AddendumTypes, Table_Addendums.Scenario, Table_Addendums.POexecuted, Table_Addendums.PenaltiesToSupplier, 
                      Table_Addendums.PenaltiesToSupplierNote, Table_Addendums.Interim, Table_Addendums.Shipment, Table_Addendums.Delivery
					  , ISNULL(RTRIM(Table7_CostCode.CostCode) + N' - ' + RTRIM(Table7_CostCode.CodeDescription), N'') AS CostCode
FROM         Table_Addendums LEFT OUTER JOIN
