<%@ Page Title="" Language="VB" MasterPageFile="~/site.master" AutoEventWireup="false" CodeFile="EnterAllInOneCreateRegularPO.aspx.vb" Inherits="EnterAllInOneCreateRegularPO" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">

<h2>Get the latest entries from the report <bold style="font:red;">RecentEntriesFrom1S.rdl</bold> </h2>
  ...
  <asp:SqlDataSource ID="SqlDataSourceFrom1S_to_PTS" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MERCURYConnectionString %>" SelectCommand="SELECT [ProjectID]
      ...
      ,[SupplierID]
      ,[Currency]
  FROM [Table_CreatePO]"></asp:SqlDataSource>
