<%@ Page Title="" Language="VB" MasterPageFile="~/site.master" AutoEventWireup="false" CodeFile="pocreateNew.aspx.vb" Inherits="_pocreateAprMx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:HiddenField ID="HiddenField_FrameContractId" runat="server" />
    ...
    <div>
        <asp:Label ID="LabelMessageToKsenia" runat="server" Font-Size="X-Large"
            ...
            <asp:TextBox id="TextBoxFrameContract" runat="server" Text="no" CssClass="hidepanel" ></asp:TextBox>
            <asp:TextBox id="TextBoxFrameContractID" runat="server" Text="0" CssClass="hidepanel" ></asp:TextBox>
                ...
                <InsertItemTemplate>
                    ...
                    <div class="col-xs-6" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2" >
                                <asp:Button ID="ButtonEnterSupplier" runat="server" CssClass="btn btn-success"
...
SELECT *
                                                        ...
                                                        AND CostCode NOT IN
                                                        (
                                                        select RTRIM(CostCode) AS CostCode from Table7_CostCode
...
<a id="lnkPopup" runat="server"></a>
    ...
    <asp:SqlDataSource ID="SqlDataSourcePO" runat="server" 
        ...
        @PersonApproved,
        @RequestedBy,
        0, @FrameContractPO, @FrameContractID)">
        <InsertParameters>
            <asp:Parameter Name="CreatedBy" />
            <asp:Parameter Name="PersonCreated" />
        </InsertParameters>
