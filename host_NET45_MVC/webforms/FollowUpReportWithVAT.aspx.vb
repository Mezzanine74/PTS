...
Partial Class _Nakl_FollowUpReportDeliveryFinanceFasterTRev
    ...
    Protected Sub ButtonRunReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonRunReport.Click
        ...
        RenderReport.Render("html", ReportViewerDeliveryReport, "_Nakl_FollowUpReportWithVATrev", "ProjectID", DropDownListPrj.SelectedValue.ToString, _
    ...
    Private Sub ExportToExcel()
        ...
        RenderReport.Render("Excel", ReportViewerDeliveryReport, "_Nakl_FollowUpReportSubWithVATrev", _
                            "Currency", _
                            _currency, _
                            "ProjectID", _
    ...
    Protected Sub ImageButtonOld_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImageButtonOld.Click
    ...
    Protected Sub GridViewRubleToExcel_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridViewRubleToExcel.RowDataBound
        ...
        Dim LabelRublePendingWithVAT As Label = DirectCast(e.Row.FindControl("LabelRublePendingWithVAT"), Label)
        Dim LabelRublePaidWithVAT As Label = DirectCast(e.Row.FindControl("LabelRublePaidWithVAT"), Label)
        ...
        If LabelInvoice_No IsNot Nothing AndAlso LabelInvoice_No.Text = "" Then
            ...
            LabelRublePendingWithVAT.Text = "Open"
            LabelRublePaidWithVAT.Text = "Open"
            ...
            LabelRublePendingWithVAT.Font.Italic = True
            LabelRublePaidWithVAT.Font.Italic = True
            ...
            LabelRublePendingWithVAT.ForeColor = System.Drawing.Color.Gray
            LabelRublePaidWithVAT.ForeColor = System.Drawing.Color.Gray
    ...
    Protected Sub GridViewDollarToExcel_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridViewDollarToExcel.RowDataBound
        ...
        Dim LabelSiteRecordNo As Label = DirectCast(e.Row.FindControl("LabelSiteRecordNo"), Label)
        Dim LabelPaymentDate As Label = DirectCast(e.Row.FindControl("LabelPaymentDate"), Label)
        Dim LabelDollarPendingWithVAT As Label = DirectCast(e.Row.FindControl("LabelDollarPendingWithVAT"), Label)
        Dim LabelDollarPaidWithVAT As Label = DirectCast(e.Row.FindControl("LabelDollarPaidWithVAT"), Label)
        ...
        If LabelInvoice_No IsNot Nothing AndAlso LabelInvoice_No.Text = "" Then
            ...
            LabelSiteRecordNo.Text = "Open"
            LabelPaymentDate.Text = "Open"
            LabelDollarPendingWithVAT.Text = "Open"
            LabelDollarPaidWithVAT.Text = "Open"
            ...
            LabelSiteRecordNo.Font.Italic = True
            LabelPaymentDate.Font.Italic = True
            LabelDollarPendingWithVAT.Font.Italic = True
            LabelDollarPaidWithVAT.Font.Italic = True
            ...
            LabelSiteRecordNo.ForeColor = System.Drawing.Color.Gray
            LabelPaymentDate.ForeColor = System.Drawing.Color.Gray
            LabelDollarPendingWithVAT.ForeColor = System.Drawing.Color.Gray
            LabelDollarPaidWithVAT.ForeColor = System.Drawing.Color.Gray
    ...
    Protected Sub GridViewEuroToExcel_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridViewEuroToExcel.RowDataBound
        ...
        Dim LabelSiteRecordNo As Label = DirectCast(e.Row.FindControl("LabelSiteRecordNo"), Label)
        Dim LabelPaymentDate As Label = DirectCast(e.Row.FindControl("LabelPaymentDate"), Label)
        Dim LabelEuroPendingWithVAT As Label = DirectCast(e.Row.FindControl("LabelEuroPendingWithVAT"), Label)
        Dim LabelEuroPaidWithVAT As Label = DirectCast(e.Row.FindControl("LabelEuroPaidWithVAT"), Label)
        ...
        If LabelInvoice_No IsNot Nothing AndAlso LabelInvoice_No.Text = "" Then
            ...
            LabelSiteRecordNo.Text = "Open"
            LabelPaymentDate.Text = "Open"
            LabelEuroPendingWithVAT.Text = "Open"
            LabelEuroPaidWithVAT.Text = "Open"
            ...
            LabelSiteRecordNo.Font.Italic = True
            LabelPaymentDate.Font.Italic = True
            LabelEuroPendingWithVAT.Font.Italic = True
            LabelEuroPaidWithVAT.Font.Italic = True
            ...
            LabelSiteRecordNo.ForeColor = System.Drawing.Color.Gray
            LabelPaymentDate.ForeColor = System.Drawing.Color.Gray
            LabelEuroPendingWithVAT.ForeColor = System.Drawing.Color.Gray
            LabelEuroPaidWithVAT.ForeColor = System.Drawing.Color.Gray
    ...
    Protected Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        If IsPostBack Or Not IsPostBack Then
            If ReportViewerDeliveryReport.Visible Then
                ...
                'LabelVATstatus.Text = "<div style=" + """" + "background-image: url('images/IncVAT.png'); background-repeat: repeat-x; height: 15px;" + """" + "></div>"
            Else
    ...
    Protected Sub ImageButtonExcelSummary_Click(sender As Object, e As System.EventArgs)
        ...
        RenderReport.Render("Excel", ReportViewerDeliveryReport, "_Nakl_FollowUpReportWithVATrev", "ProjectID", DropDownListPrj.SelectedValue.ToString, _
                           "Currency", DropDownListCurrency.SelectedValue.ToString)
